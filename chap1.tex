...
\begin{theorem} \label{1.2}
	...
	\end{proof}
\end{theorem}
such that $u \in H$ is the unique solution t0 the problem \eqref{weak-formulation} and with that is the resolvent mapping $R_{\mu} \colon L^{2}(\R) \rightarrow H^{1}(\R), f \mapsto u$ well-defined; obviously the mapping is one-to-one since for $u_{1} = u_{2}$
