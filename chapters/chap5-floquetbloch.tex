...
\begin{theorem} \label{3.2:thm-UIsometricIsomorphism}
	...
	\begin{proof}
		...
		Thus, $(Uf)(x, k)$ is well-defined by \eqref{floquet-transformation} (as a Fourier series with variable $k$) for almost every $x \in \Omega$. Using Parseval's identity (Theorem \ref{athm:parseval}) and the fact that 
