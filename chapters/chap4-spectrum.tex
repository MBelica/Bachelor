...
~\\ ~\\
To show this equality we first need to characterise the dependence of $I_{s}$ from $k$, more specifically that $\lambda_{s}(k)$ is continuous in $k$ and hence $I_{s}$ is for each $k$ a compact interval.
