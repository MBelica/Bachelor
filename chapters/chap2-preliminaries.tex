...
Let $\Omega \subseteq \R$ be open. Let $C_{0}^{\infty}(\Omega)$ denote the linear space containing all smooth function $f \colon \Omega \rightarrow \R$ with compact support, i.e. for $f \in C_{0}^{\infty}(\Omega)$ there exists $I \subseteq \Omega$ such that $f(x) = 0$ for all $x \notin I$. Let $I$ denote the identity operator on the respective space $I x = x$ and hereafter $\langle x, x \rangle$ will denote the scalar product in $L^{2}(\R)$.
...
From now on in the remainder of this thesis, we denote with $\mathfrak{D}'(\Omega)$ the space of all linear functionals on $C_{0}^{\infty}(\Omega)$ that are continuous with respect to this topology and call those functionals distributions.  
~\\
