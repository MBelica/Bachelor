...
\begin{definition}
	Let $U_{X} = \{ x \in X \colon |x| < 1 \}$, $X$ be a normed space and $Y$ a Banach space. A linear operator $A \colon X \rightarrow Y$ is called compact, if $T(U_{X})$ is relative compact in $Y$.
\end{definition}
