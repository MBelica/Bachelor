...
\section{\texorpdfstring{The spectrum of the restricted operator $A_{k}$}{The spectrum of the restricted operator Ak}}	
...
Then,
	\begin{align*}
		A_{k} \psi_{s}(x, k) & = \frac{d}{dx} \psi_{s}(x, k)|_{(x_{0} - \frac{1}{2}, x_{0})} \cdot \mathds{1}_{(x_{0} - \frac{1}{2}, x_{0})} + \frac{d}{dx} \psi_{s}(x, k)|_{(x_{0}, x_{0}  + \frac{1}{2})} \cdot \mathds{1}_{(x_{0}, x_{0} + \frac{1}{2})} \\
