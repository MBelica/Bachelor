...
% todo Martin: Implement Andrii's Propositions; Martin/Andrii do I have to show that $f - \mu$ u is onto though $\mu$ is fixed
...
\section{\texorpdfstring{$A$ being self-adjoint}{A being self-adjoint}}
