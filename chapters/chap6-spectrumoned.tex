...
\begin{figure}
 ...
 \end{axis}
 \end{tikzpicture}%	
 \caption{Example for the function $\eta$}
\end{figure}
...
\begin{figure}
 \begin{tikzpicture}
  ...
  \end{axis}
 \end{tikzpicture}%
 \caption{A schematic of the real part of the Bloch wave in one dimension.}
\end{figure}
...
\begin{figure}
 \begin{tikzpicture}
  ...
  \end{axis}
 \end{tikzpicture}%
 \caption{Resulting real-part of the function $u_{l}$}
\end{figure}		
