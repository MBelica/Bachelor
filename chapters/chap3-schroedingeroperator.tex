...
\begin{theorem} \label{2.1:thm-LaxMilgram}
	...
	\begin{proof} ~\\
		...
		$b)$ Let $u \in H^{1}(\R)$. For the coercivity, we note first that for the given sesquilinear form $B[u, u] \in \R$ holds. Assuming first $\rho \geq 0$ yields for $\mu < -1$ that % todo proof B[u, u] in R
		\begin{align*}
