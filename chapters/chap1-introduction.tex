...
Assuming the spacing between all ions is equidistant the potential function $V(x)$ in the lattice can be approximated by a rectangular potential as depicted in Figure \ref{figure-kpm}, where $b$ is the \enquote{support} and $\rho$ the magnitude of the potentials. % todo quotes entfernen und gegenbenfalls auf etwas wie pyhysikalischen support verweisen % todo ref auf figure
	\vspace{0.25cm}
	\begin{figure}[!ht] \centering % todo matej fragenw as er meinte mit htb? was gefällt ihm micht an der positionierung des Bildes
