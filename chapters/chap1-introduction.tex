	...
	\begin{figure}[!ht] \centering 
	  \resizebox{.8\linewidth}{!}{
		...
		\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
			...
			\draw (0.1,4.25) node[anchor=north west] {$V(x)$};
			\draw (5,-0.1) node[anchor=north west] {$x$};
		  \end{tikzpicture}
	    }
